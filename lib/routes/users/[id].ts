...
import { logRoleChange, logStatusChange, logUserDeletion } from '../../audit-logger.js';
import {
  preventSelfDemotion,
  validateBody,
  validateQuery,
...
import { updateUserSchema, userIdSchema } from '../../schemas/user.js';
  ...
  withErrorHandling(
    withAuth(
      withSelfOrAdmin(req => req.query.id as string)(
        validateQuery(userIdSchema)(async (req: AuthenticatedRequest, res: VercelResponse) => {
