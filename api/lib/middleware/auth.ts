 ...
 */
export async function authenticateRequest(req: AuthenticatedRequest, res: VercelResponse): Promise<boolean> {
 ...
 */
export async function requireAdmin(req: AuthenticatedRequest, res: VercelResponse): Promise<boolean> {
 ...
 */
export async function requireUser(req: AuthenticatedRequest, res: VercelResponse): Promise<boolean> {
