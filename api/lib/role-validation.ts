 ...
 */
export function preventSelfDemotion(currentUser: any, targetUser: any, newRoles: string[]): void {
 ...
 */
export function preventSelfDeactivation(currentUser: any, targetUser: any, isActive: boolean): void {
  const currentUserId = currentUser.userId || currentUser.id;
 ...
 */
export function requiresConfirmation(currentRoles: string[], newRoles: string[]): boolean {
 ...
 */
export function getRoleChangeDescription(oldRoles: string[], newRoles: string[]): string {
