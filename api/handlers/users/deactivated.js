import { withCORS, withErrorHandling, withAuth, withAdminRole, validateQuery } from '../../lib/middleware/index.js';
import prisma from '../../lib/prisma.js';
import { getUsersSchema } from '../../lib/schemas/user.js';
// GET /api/users/deactivated - List deactivated users (admin only)
const getDeactivatedUsersHandler = withCORS(withErrorHandling(withAuth(withAdminRole(validateQuery(getUsersSchema)(async (req, res) => {
...
async function handleGetDeactivatedUsers(req, res) {
