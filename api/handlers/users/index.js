...
import { withCORS, withErrorHandling, withAuth, withAdminRole, validateBody, validateQuery } from '../../lib/middleware/index.js';
...
const getUsersHandler = withCORS(withErrorHandling(withAuth(validateQuery(getUsersSchema)(async (req, res) => {
    await handleGetUsers(req, res);
}))));
// POST /api/users - Create user (admin only)
const createUserHandler = withCORS(withErrorHandling(withAuth(withAdminRole(validateBody(createUserSchema)(async (req, res) => {
...
async function handleGetUsers(req, res) {
    ...
    const { page, size, search, active, role, createdFrom, createdTo, sort, order } = req.query;
    const where = {};
